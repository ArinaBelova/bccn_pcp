# Make a copy of the board one step before the action
# Update it in apply_player_action()
...
from agents.agent_mcts_nn import mcts_move, mcts_basic_move


def human_vs_agent(
    generate_move_1: GenMove = mcts_basic_move,
    ...
    print(f"Player 1 won {wins_1} times and Player 2 won {wins_2} times")
